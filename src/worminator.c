...
void change_resolution(int x, int y)
{
	...
	if (get_color_depth() == 8) {
		...
		gui_fg_color = makecol(225, 225, 225);
		gui_bg_color = makecol(50, 50, 50);
	}
...
void initialize()
{
...
#ifndef PSVITA // Disable mouse for Vita. Mouse driver implementation in allegro needs improvement.
	...
	backgroud_menu_box = create_bitmap_ex(8, 254, 174);
